...
import { View, StyleSheet, Text, TouchableOpacity, ScrollView, disabled } from 'react-native';
...
const AssistentSecV = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.Textstyle}>Assistent Secretary</Text>
      ...
      <ScrollView>
        ...
        <View style={{
          backgroundColor: 'white', height: 900, width: 435, borderTopLeftRadius: 70,
